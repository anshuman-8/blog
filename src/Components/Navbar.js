  ...
  return (
      ...
      <div className="dark:bg-teal-900">
          <div className="flex flex-row justify-between items-center px-3 py-4 mx-5 md:mx-20">
            <Link className=" text-xl md:text-2xl hover:underline" to="/blog">
              ...
              <ul className="flex flex-row justify-evenly" role="search">
                ...
                <button className="md:px-4 px-3" type="button" onClick={()=>setIsDark(!isDark)}>
                {isDark
                  ? <span title="Dark Mode!"><MoonIcon /></span>
                  : <span title="Light Mode"><SunIcon /></span>
                }
                </button>  
                <a href="https://github.com/anshuman-8" title="My GitHub" target="_blank" className="hidden md:px-4 md:inline-block" rel="noreferrer"><span><GitHubIcon/></span></a> 
