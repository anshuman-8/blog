    ...
    <div className="container">
      ...
      <div className="row row-cols-1 row-cols-md-3  g-4">
        {data.map((item, index) => {
          ...
          return (
            <div key={item.id}  >
              <div className="card" style={{ width: "18rem",cursor:'pointer',textDecoration:"none" }} onClick={()=>setBlogData(item)}  >
                <img
                ...
                <div className="card-body">
                  ...
                  {/* <Link key={item.id} to={{pathname:"/blog",query:{item,ctx}}}>Read More ..</Link> */}
